...
final class MovieFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $movie->addActor($this->getReference('actor_1', \App\Entity\Actor::class));
        $movie->addActor($this->getReference('actor_2', \App\Entity\Actor::class));
        ...
        // Add Data To Pivot Table
        $movie1->addActor($this->getReference('actor_2', \App\Entity\Actor::class));
        $movie1->addActor($this->getReference('actor_3', \App\Entity\Actor::class));
        ...
        // Add Data To Pivot Table
        $movie2->addActor($this->getReference('actor_4', \App\Entity\Actor::class));
        $movie2->addActor($this->getReference('actor_5', \App\Entity\Actor::class));
